...
${Output_folder}    ${CURDIR}${/}Reports
${image_folder}     ${CURDIR}${/}Reports${/}image_files
${pdf_folder}       ${CURDIR}${/}Reports${/}pdf_files
${csv_url}          https://robotsparebinindustries.com/orders.csv
${orders_file}      ${CURDIR}${/}input${/}orders.csv
${zip_file}         Reports${/}pdf_archive.zip
...
Directory Cleanup
    ...
    Create Dictionary    ${Output_folder}    ${False}    #${True}
    Create Dictionary    ${pdf_folder}    ${False}    #${True}
    Create Dictionary    ${image_folder}    ${False}    #${True}
...
Get The User Name
    ...
    Add text input    myname    label=What is your name?    placeholder=Enter your name here
    ${result}=    Run dialog
...
Display the success dialog
    [Arguments]    ${USER_NAME}
    Add icon    Success
    Add heading    Orders Processed!!
    Add text    Dear ${USER_NAME} - Bot processed all the orders successfully
